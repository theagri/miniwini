...
return array(
	...
	'connections' => array(
		...
		'openid' => array(
			'host' => 'http://s2.miniwini.com',
			'required_fields' => array('namePerson/friendly', 'contact/email'),
			'optional_fields' => array(),
			'return_to' => 'http://s2.miniwini.com/auth/connected/openid'
		),
		
		'facebook' => array(
			'client_id' => '',
			'client_secret' => '',
			'redirect_uri' => 'http://s2.miniwini.com/auth/connected/facebook',
		...
		'google' => array(
			'return_to' => 'http://s2.miniwini.com/auth/connected/google',
		),
	
		'foursquare' => array(
			'client_id' => '',
			'client_secret' => '',
			'redirect_uri' => 'http://s2.miniwini.com/auth/connected/foursquare'
		),
	
		'twitter' => array(
			'consumer_key' => '',
			'consumer_secret' => '',
			'oauth_callback' => 'http://s2.miniwini.com/auth/connected/twitter'
		),
	
		'linkedin' => array(
			'consumer_key' => '',
			'consumer_secret' => '',
			'oauth_callback' => 'http://s2.miniwini.com/auth/connected/linkedin'
		),
	),
