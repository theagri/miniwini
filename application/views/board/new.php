			...
			<section data-group="board" data-form="general" data-type="post">
				...
				<div id="add-series">
					...
					<div>
						<input type="radio" name="series" id="series-2" value="2" class="togg"><label for="series-2"><?=__('miniwini.board.newpost.series_type.new_series')?></label>
						<div id="new-series">
				...
				<div class="multiple-actions">
					...
					<input type="submit" value="<?=__('miniwini.board.newpost.button.submit')?>">
				</div>
